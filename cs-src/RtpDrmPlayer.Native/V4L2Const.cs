...
public static class V4L2Const
{
    ...
    public const uint V4L2_EVENT_SRC_CH_RESOLUTION = 1;
    public const uint V4L2_CID_MIN_BUFFERS_FOR_CAPTURE = 9963815;
    public const uint V4L2_BUF_FLAG_ERROR = 0x0040;
    public const uint V4L2_BUF_FLAG_LAST = 0x00100000;
    public const ulong VIDIOC_QUERYCAP = 0x80685600;
    public const ulong VIDIOC_G_FMT = 3234878980;
    public const ulong VIDIOC_S_FMT = 3234878981;
    ...
    public const ulong VIDIOC_DQEVENT = 2156418649;
}